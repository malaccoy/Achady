...
const CATEGORY_PRESETS_BR = {
  ...
  'bolsas_e_acessorios': 100108,
  'beleza': 100109,
  'eletronicos': 100110,
  'celulares_e_tablets': 100111,
  'computadores_e_acessorios': 100112,
  'casa_e_decoracao': 100113,
  'cozinha': 100114,
  'esportes': 100115,
  'brinquedos': 100116,
  'bebes_e_criancas': 100117,
  'pet_shop': 100118,
  'automotivo': 100119,
  'games': 100120,
  'livros': 100121,
 ...
 * 
 * @param {string} raw - The raw input string (can be a numeric ID or category name)
 * @returns {number|null} The numeric category ID, or null if not found/invalid
 * 
 * @example
 ...
 */
function resolveShopeeCategoryId(raw) {
